 ...
 */
   ...
   */
    ...
    arm_status arm_convolve_HWC_q7_RGB(const q7_t * Im_in,
                        ...
                        const int32_t bias_shift,
                        const int32_t out_shift,
                        q7_t * Im_out, const int32_t dim_im_out, q15_t * bufferA, q7_t * bufferB);
 ...
 */
   ...
   */
    ...
    arm_status arm_fully_connected_q7(const q7_t * pV,
                       const q7_t * pM,
                       const int32_t dim_vec,
                       const int32_t num_of_rows,
                       const int32_t bias_shift,
                       const int32_t out_shift, const q7_t * bias, q7_t * pOut, q15_t * vec_buffer);
 ...
 */
   ...
   */
    ...
    q7_t     *arm_nn_mat_mult_kernel_q7_q15_reordered(const q7_t * pA,
                                                      const q15_t * pInBuffer,
                                                      const uint32_t ch_im_out,
                                                      const uint32_t numCol_A,
                                                      const uint32_t bias_shift,
                                                      const uint32_t out_shift, 
                                                      const q7_t * bias, 
                                                      q7_t * pOut);
 ...
 */
   ...
   */
    ...
    void      arm_relu_q7(q7_t * data, int32_t size);
   ...
   */
    ...
    void      arm_relu_q15(q15_t * data, uint32_t size);
 ...
 */
   ...
   */
    ...
    void      arm_maxpool_q7_HWC(q7_t * Im_in,
                   ...
                   const int32_t dim_kernel,
                   const int32_t padding,
                   const int32_t stride, const int32_t dim_im_out, q7_t * bufferA, q7_t * Im_out);
