...
static void buffer_scale_back_q15_to_q7(q15_t * buffer, q7_t * target, int32_t length, int32_t scale)
{
    int       i;
...
static void accumulate_q7_to_q15(q15_t * base, q7_t * target, const int32_t length)
{
    q15_t    *pCnt = base;
    q7_t     *pV = target;
    q31_t     v1, v2, vo1, vo2;
