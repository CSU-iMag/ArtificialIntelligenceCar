                                                  ...
                                                  q7_t * bufferB)
{
    ...
    for (i_out_y = 0; i_out_y < dim_im_out_y; i_out_y++)
    {
        for (i_out_x = 0; i_out_x < dim_im_out_x; i_out_x++)
        {
            ...
            arm_q7_to_q15_reordered_no_shift((q7_t *) Im_in + (i_out_y * dim_im_in_x * stride_y + i_out_x * stride_x) * ch_im_in, pBuffer,
                                             ch_im_in);
            pBuffer += ch_im_in;
    ...
    if (pBuffer != bufferA)
    {
        ...
        for (i_ch_out = 0; i_ch_out < ch_im_out; i_ch_out++)
        {
            ...
            int32_t  colCnt = ch_im_in * dim_kernel_x * dim_kernel_y >> 2;
